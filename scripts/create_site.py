...
## First 72 hours
1. Rewrite homepage hero and preschool path around ages 2–6: joy, confidence, socialization, first class, Spanish Fort convenience.
2. Add a dedicated `Tiny Dancers / Ages 2–6` landing page with trial-class CTA, schedule/fallback, teacher trust, parent FAQs, and “close to home” copy.
3. Fix or bypass class-finder friction for preschool classes: show clear age/day/time options or a “Text/call us and we’ll place your child” fallback.
4. Add a no-pressure offer: “Book a free trial class” or “Try your first Tiny Dancer class.”
5. Replace career-heavy proof above the fold with toddler-parent proof: smiling first class, teacher warmth, confidence, making friends.
...
3. Ask 10 current preschool/kindergarten parents for short testimonial lines and phone-shot clips.
4. Create Google Business Profile posts/services for toddler dance, preschool dance, creative movement, beginner ballet/tap.
5. Track every inquiry source manually in a shared sheet until analytics are wired.
...
3. Build referral loop: “Bring a preschool friend week.”
...
<section class="section" id="swot"><div class="eyebrow">SWOT</div><h2>What GCDA can use — and what can hurt if we ignore it.</h2><div class="swot"><article class="card"><h3>Strengths</h3><ul><li>Only dance school in Spanish Fort.</li><li>Real dance-education credibility and faculty depth.</li><li>Strong facility/photo proof available.</li><li>Contact form now repaired.</li></ul></article><article class="card"><h3>Weaknesses</h3><ul><li>Preschool parent message is not sharp enough.</li><li>Class finder/schedule friction remains high priority.</li><li>Proof is not packaged around ages 2–6.</li><li>Pricing may feel high if value is unclear.</li></ul></article><article class="card"><h3>Opportunities</h3><ul><li>Own “first dance class in Spanish Fort.”</li><li>Turn traffic avoidance into value.</li><li>Launch Tiny Dancer Starter Session.</li><li>Use current families for reviews/referrals.</li></ul></article><article class="card"><h3>Threats</h3><ul><li>Parents keep driving to warmer-feeling competitors.</li><li>Small cohort magnifies each lost family.</li><li>Discounting without diagnosis weakens positioning.</li><li>Unclear schedule kills social traffic conversion.</li></ul></article></div></section>
...
<section class="section" id="action"><div class="eyebrow">Immediate action</div><h2>Fix presentation before making permanent business changes.</h2><div class="timeline"><article class="time" data-day="72h"><h3>First 72 hours</h3><p>Build the Tiny Dancer path: homepage copy, dedicated ages 2–6 landing page, trial CTA, clear schedule/fallback, teacher warmth, parent FAQ, and preschool proof.</p></article><article class="time" data-day="7d"><h3>First 7 days</h3><p>Launch “Your first dance class, close to home.” Publish 7 short videos, ask 10 parents for proof, update GBP services/posts, and manually track every inquiry source.</p></article><article class="time" data-day="30d"><h3>First 30 days</h3><p>Run a Tiny Dancer Starter Session, referral week, preschool/daycare outreach, review sprint, and offer test before any permanent tuition cut.</p></article></div></section>
...
<section class="section" id="video"><div class="video-wrap"><video controls preload="metadata" poster="/media/gcda-growth-explainer-poster.jpg"><source src="/media/gcda-growth-explainer.mp4" type="video/mp4"></video><div><div class="eyebrow">Existing explainer</div><h2>Prior narrated strategy remains available.</h2><p>The updated control panel now adds the deeper Spanish Fort ages 2–6 market-share recovery layer before implementation.</p><a class="btn rose" href="/media/gcda-growth-explainer.mp4">Download MP4</a></div></div></section>
<section class="section" id="briefs"><div class="eyebrow">Briefs</div><h2>Working artifacts for action.</h2><div class="brief-grid"><a class="card" href="/briefs/goal-and-positioning.md"><h3>Goal + Positioning</h3><p>North star and message shift.</p></a><a class="card" href="/briefs/swot-2-6-market.md"><h3>SWOT</h3><p>Strengths, weaknesses, opportunities, threats.</p></a><a class="card" href="/briefs/immediate-action-plan.md"><h3>Immediate Action Plan</h3><p>72 hours, 7 days, 30 days.</p></a><a class="card" href="/briefs/pricing-hypothesis.md"><h3>Pricing Hypothesis</h3><p>How to test the $15 question.</p></a><a class="card" href="/briefs/website-and-social-creative-brief.md"><h3>Website + Social Brief</h3><p>Creative direction and content ideas.</p></a><a class="card" href="/briefs/control-panel-metrics.md"><h3>Control Metrics</h3><p>Weekly dashboard and thresholds.</p></a></div></section>
<footer><p>GCDA Preschool Market Recovery Control Panel · built for immediate decision-making before site/social implementation.</p><p><a href="https://gcdadance.com">gcdadance.com</a> · <a href="https://gcda-growth-blueprint.netlify.app">control panel</a></p></footer></body></html>'''
